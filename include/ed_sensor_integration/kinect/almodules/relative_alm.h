...
#ifndef ed_sensor_integration_kinect_relative_alm_h_
#define ed_sensor_integration_kinect_relative_alm_h_
...
#endif // ed_sensor_integration_kinect_relative_alm_h_
